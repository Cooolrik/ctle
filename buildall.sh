...
mkdir build_c++11
cd build_c++11
cmake .. -DCMAKE_CXX_STANDARD=11 -DBUILD_TESTS=ON
cmake --build .
...
mkdir build_c++14
cd build_c++14
cmake .. -DCMAKE_CXX_STANDARD=14 -DBUILD_TESTS=ON
cmake --build .
...
mkdir build_c++17
cd build_c++17
cmake .. -DCMAKE_CXX_STANDARD=17 -DBUILD_TESTS=ON
cmake --build .
...
mkdir build_c++20
cd build_c++20
cmake .. -DCMAKE_CXX_STANDARD=20 -DBUILD_TESTS=ON
cmake --build .
