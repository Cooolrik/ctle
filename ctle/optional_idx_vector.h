...
public:
	...
	{}
	optional_idx_vector &operator = ( const optional_idx_vector &_other )
	{
		this->vector_m = _other.vector_m; this->has_value_m = _other.has_value_m; return *this;
	}
	optional_idx_vector( optional_idx_vector &&_other ) noexcept : vector_m( std::move( _other.vector_m ) ), has_value_m( _other.has_value_m )
	{
		_other.has_value_m = false;
	}
	optional_idx_vector &operator = ( optional_idx_vector &&_other )
	{
		this->vector_m = std::move( _other.vector_m ); this->has_value_m = _other.has_value_m; _other.has_value_m = false; return *this;
	}
	...
	void reset()
	{
		this->has_value_m = false; this->vector_m.clear();
	}
	void set()
	{
		this->has_value_m = true; this->vector_m.clear();
	}
	void set( const idx_vector<_Ty, _IdxTy, _VecTy> &_vector )
	{
		this->has_value_m = true; this->vector_m = _vector;
	}
	void set( const values_vector_type &_values, index_vector_type &_index )
	{
		this->has_value_m = true; this->vector_m.values() = _values; this->vector_m.index() = _index;
	}
	bool has_value() const
	{
		return this->has_value_m;
	}
